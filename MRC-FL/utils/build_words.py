...
def check_label():
    word_dict = {}
    with open('/home/fmxuxu/pretrain_models/cased_glove_word_list.txt', 'r') as fr:
        lines = fr.readlines()
        for line in lines:
            word = line.strip()
    ...
    for prefix in ['trigger', 'argument']:
        ...
        type_list = get_labels(
            '/home/fmxuxu/onepass_ie/data/ace05/splited/{}_label_map.json'.format(prefix))[1].keys()
...
if __name__ == "__main__":
    w2v_path = '/home/fmxuxu/pretrain_models/glove.840B.300d.txt'
    glove_out_file = '/home/fmxuxu/pretrain_models/glove.840B.300d_word2vec.txt'
    output_dir = '/home/fmxuxu/dataset/imdb'
    convert_glove_format(w2v_path, glove_out_file)
    word2vec = load_glove(glove_out_file)
    build_words(word2vec, output_dir,
                '/home/fmxuxu/pretrain_models/', add_begin_token=False)
