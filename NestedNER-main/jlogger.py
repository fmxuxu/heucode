...
class Evaluate_Logger:
    ...
    def print_result(self, epoch, update, valid_log_output, test_log_output, alpha):
        ...
        data_name = "ontonote4"
        orig_data_file = f"/mnt/LJH/XFM/NERProject/spanCL/data/reduce_emb_dataset/{data_name}/dev.txt.clip"
        output_data_file = f"/mnt/LJH/XFM/NERProject/spanCL/data/reduce_emb_dataset/__ckpts/{data_name}/tener_crf/wrong_result.txt"
